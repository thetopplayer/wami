...
//  MyWami
//
//  Created by Robert Lanter on 5/11/15.
//  Copyright (c) 2015 Robert Lanter. All rights reserved.
//

import UIKit

class WamiRadioBtn: UIButton {
    let enabledImage = UIImage(named: "radioBtnEnabled")
    let disabledImage = UIImage(named: "radioBtnDisabled")
